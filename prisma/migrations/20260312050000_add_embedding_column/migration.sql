-- Migration: add_embedding_column
-- Re-adds the 1536-dimensional embedding column to KnowledgeChunk and creates
-- an HNSW index for fast approximate cosine similarity search.
-- This migration restores the vector column that was dropped in the previous migration.
