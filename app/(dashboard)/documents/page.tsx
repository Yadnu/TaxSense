    ...
    <div className="flex flex-col">
      ...
      <div className="space-y-6 p-6">
        ...
        <section>
          <div className="mb-3 flex items-center justify-between">
            <h2 className="section-title">
              Uploaded documents
              {!isLoading && (
                <span className="ml-2 rounded-full bg-slate-100 px-2 py-0.5 text-xs font-medium text-gray-500">
                  {documents.length}
                </span>
              )}
            </h2>
            ...
            {error && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-medium text-blue-900 hover:underline"
              >
        ...
        <section className="rounded-lg border border-blue-100 bg-blue-50 p-4">
          <p className="text-sm font-medium text-blue-900">What documents do I need?</p>
